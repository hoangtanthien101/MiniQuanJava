                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                                ...
                                <ul class="addressFooter">
                                    <li><i class="icon anm anm-map-marker-al"></i>
                                        <p>Hùng Vương, Lệ Thủy, Quảng Bình</p>
                                    </li>
                                ...
                                <div class="footer-social">
                                    ...
                                    <ul class="list--inline site-footer__social-icons social-icons">
                                        <li><a class="social-icons__link" href="https://www.facebook.com/hoangthien.1001" target="_blank"
                                        ...
                                        <li><a class="social-icons__link" href="https://www.instagram.com/thien_1001/" target="_blank"
                                        ...
                                        <li><a class="social-icons__link" href="https://www.youtube.com/@FPTPoly" target="_blank"
                            ...
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Đơn đặt hàng &amp; trả lại</a></li>
                    ...
                    <div class="footer-bottom">
                        <div class="row">
                            ...
                            <div
                                ...
                                <span></span> <a href="templateshub.net">Trung tâm</a>
                            </div>
