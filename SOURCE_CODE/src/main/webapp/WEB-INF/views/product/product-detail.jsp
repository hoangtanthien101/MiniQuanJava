			...
			<div id="MainContent" class="main-content" role="main">
				...
				<div class="bredcrumbWrap">
					<div class="container breadcrumbs" role="navigation"
						...
						<a href="/" title="Back to the home page">Trang chủ</a><span
								...
								<div class="product-single__meta">
									...
									<div class="prInfoRow">
										<div class="product-stock">
											<span class="instock ">Trong kho</span>
										</div>
									</div>
									<p
										...
										<div class="product-image">
											...
											<form class="variants add">
												<button ng-click="cart.add(${p.product.id})"
													class="btn btn-addto-cart" type="button" tabindex="0">THÊM VÀO GIỎ HÀNG</button>
											</form>
