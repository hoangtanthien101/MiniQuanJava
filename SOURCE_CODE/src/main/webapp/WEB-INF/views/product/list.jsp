		...
		<div id="page-content">
			...
			<div class="collection-header">
				<div class="collection-hero">
					...
					<div class="collection-hero__title-wrapper" style="position:relative;">
						<h1 class="collection-hero__title page-width" style="top:50%; height:150px; position:absolute;">DANH SÁCH SẢN PHẨM</h1>
					</div>
				</div>
			</div>
									...
									<div class="row">
										<div class="col-3 col-md-3 col-lg-3 text-left">
											<div class="filters-toolbar__item">
												<label for="SortBy" class="hidden">Loại</label> <select
